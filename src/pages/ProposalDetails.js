        ...
        <Flex m="4" flexDir="column">
          ...
          <Flex justifyContent={'space-between'}>
            <Flex m="2">
              <Text>
                Votes in favour:{' '}
                <Text color="green" fontWeight="bold" as="span">
                  {proposal.upvotes}
                </Text>{' '}
                |{' '}
              </Text>
              <Text>
                {' '}
                &nbsp; Votes against:{' '}
                <Text color="brand.400" fontWeight="bold" as="span">
                  {proposal.downvotes}
                </Text>
              </Text>
            </Flex>
            <Flex>
              <Button m="2" bg="green" color="white">
                Upvote
              </Button>
              <Button m="2" bg="brand.400" color="white">
                Downvote
              </Button>
            </Flex>
          </Flex>
